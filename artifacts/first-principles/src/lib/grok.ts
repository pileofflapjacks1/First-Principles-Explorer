  ...
  "breakdown": [
    {
      ...
      "image_prompt": "string (a detailed image-generation prompt that visually explains THIS specific level. Always target ultra-photorealistic rendering: real-world materials, physically accurate lighting, macro/microscopic photography style, depth of field, sharp focus. Prefer styles like 'ultra-photorealistic macro photograph', 'photorealistic scanning electron microscope image', 'photorealistic studio product shot', or 'hyperrealistic cutaway rendering'. Avoid cartoon, illustration, or diagram styles. Include specific material textures, lighting rigs, and camera lens details to anchor realism. 1-3 sentences, ~40 words. Example: 'Ultra-photorealistic macro photograph of a silicon P-N junction cross-section, scanning electron microscope aesthetic, metallic and crystalline textures, blue-tinted depletion zone glowing under studio lighting, razor-sharp depth of field, dark background, 8K resolution')"
    }
  ],
